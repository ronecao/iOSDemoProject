...
/**
 * Returns an instance of SOAPTransactionHistory. This method should only be called after CardEaseMobile
 ...
 * {@link CardEaseMobileProperties::isTransactionHistorySupported} and  {@link CardEaseMobileProperties::isTransactionHistorySetUp} methods.
 *
 ...
 * 
 * This method is also called internally when {@link CardEaseMobileProperties::save:} is invoked,
 * if application mode or SOAP credentials were changed. It ensures that the instance uses the right credentials. 
 * It means that a new copy of SOAPTransactionHistory instance should be retrieved after changing the CardEaseMobileProperties.
 */
+(void)dispose;
